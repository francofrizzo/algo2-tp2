...
\servUsados{diccAVL, Heap, Red, dicc\_trie, tupla, conjunto }
...
\begin{Representacion}
  ...
  \begin{Estructura}{dcnet}[estrDCNet]
    ...
    \begin{Tupla}[estrDCNet]
      \tupItemNL{red}{red}
      \tupItemNL{IDsCompusPorIP}{dicc\_trie(string, nat)}
      \tupItemNL{siguientesCompus}{ad(ad(nat))}
      \tupItemNL{paquetesEnEspera}{ad(tupla(enConjunto: conj(paquete), porID: diccAVL(ID, tupla(iPaquete: itConj(paquete),codOrigen: nat, codDestino: nat), porPrioridad: heap(tupla(prioridad, itConjunto(paquete))))))}
      \tupItemNL{\#PaqEnviados}{ad(nat)}
      \tupItemNL{laQueM\'asEnvi\'o}{itRed}
      \tupItemNL{IPsCompuPorID}{ad(itRed)}
    \end{Tupla}
...
%1
		(tam($e$.paquetesEnEspera) = tam($e$.IPcompusPorID) = tam($e$.siguienteCompu) = tam($e$.cantPaquetesEnviados) = \#(computaodras($e$.estrRed))) $\land$ 
...
\tadOperacion{caminoDelPaquete}{ad(ad(nat)), ad(ItRed), ad(tupla(enConjunto: conj(paquete), porID: diccAVL(ID{,} tupla(iPaquete: itConj(paquete){,}codOrigen: nat{,} codDestino: nat{,} porPrioridad: heap(tupla(prioridad{,} itConjunto(paquete)))))), paquete, ad(tupla(enConjunto: conj(paquete), porID: diccAVL(ID{,} tupla(iPaquete: itConj(paquete){,}codOrigen: nat{,} codDestino: nat{,} porPrioridad: heap(tupla(prioridad{,} itConjunto(paquete))))))}{secu(compu)}{} %FALTA AGREGAR RESTRICCION y alinear bien los parametros - Manu 
...
\tadOperacion{caminoDelPaquete$_{\text{aux}}$}{ad(ad(nat)), ad(ItRed), ad(tupla(enConjunto: conj(paquete){,} porID: diccAVL, tupla(iPaquete: itConj(paquete){,}codOrigen: nat{,} codDestino: nat{,} porPrioridad: heap(tupla(prioridad{,} itConjunto(paquete)))))), paquete, ad(tupla(enConjunto: conj(paquete), porID: diccAVL(ID{,} tupla(iPaquete: itConj(paquete){,}codOrigen: nat{,} codDestino: nat{,} porPrioridad: heap(tupla(prioridad{,} itConjunto(paquete)))))), nat, nat}{secu(compu)}{} %AGREGAR RESTRICCION  

\small\begin{verbatim}
\tadOperacion{caminoDelPaquete$_{\text{aux}}$}{ad(ad(nat)), ad(ItRed), ad(tupla(enConjunto:
conj(paquete){,} porID: diccAVL, tupla(iPaquete: itConj(paquete){,}codOrigen: nat{,}
codDestino: nat{,} porPrioridad: heap(tupla(prioridad{,} itConjunto(paquete)))))),
paquete, ad(tupla(enConjunto: conj(paquete), porID: diccAVL(ID{,} tupla(iPaquete:
itConj(paquete){,}codOrigen: nat{,} codDestino: nat{,} porPrioridad: heap(tupla(prioridad{,}
itConjunto(paquete)))))), nat, nat}{secu(compu)}{}
\end{verbatim}
...
\tadOperacion{finAd}{ad(tupla(enConjunto: conj(paquete), porID: diccAVL(ID{,} tupla(iPaquete: itConj(paquete){,}codOrigen: nat{,} codDestino: nat{,} porPrioridad: heap(tupla(prioridad{,} itConjunto(paquete)))))))}{ad(tupla(enConjunto: conj(paquete), porID: diccAVL(ID{,} tupla(iPaquete: itConj(paquete){,}codOrigen: nat{,} codDestino: nat{,} porPrioridad: heap(tupla(prioridad{,} itConjunto(paquete)))))))}{}
\small\begin{verbatim}
\tadOperacion{finAd}{ad(tupla(enConjunto: conj(paquete), porID: diccAVL(ID{,} tupla(iPaquete:
itConj(paquete){,}codOrigen: nat{,} codDestino: nat{,} porPrioridad: heap(tupla(prioridad{,}
itConjunto(paquete)))))))}{ad(tupla(enConjunto: conj(paquete), porID: diccAVL(ID{,} tupla(iPaquete:
itConj(paquete){,}codOrigen: nat{,} codDestino: nat{,} porPrioridad: heap(tupla(prioridad{,}
itConjunto(paquete)))))))}{}
\end{verbatim}
...
\tadOperacion{finAd$_{\text{aux}}$}{ad(tupla(enConjunto: conj(paquete), porID: diccAVL(ID{,} tupla(iPaquete: itConj(paquete){,}codOrigen: nat{,} codDestino: nat{,} porPrioridad: heap(tupla(prioridad{,} itConjunto(paquete)))))))/a, ad(tupla(enConjunto: conj(paquete), porID: diccAVL(ID{,} tupla(iPaquete: itConj(paquete){,}codOrigen: nat{,} codDestino: nat{,} porPrioridad: heap(tupla(prioridad{,} itConjunto(paquete)))))))/b, nat}{ad(tupla(enConjunto: conj(paquete), porID: diccAVL(ID{,} tupla(iPaquete: itConj(paquete){,}codOrigen: nat{,} codDestino: nat{,} porPrioridad: heap(tupla(prioridad{,} itConjunto(paquete)))))))}{tam(a)>1 $\land$ tam(b)>0}

\small\begin{verbatim}
\tadOperacion{finAd$_{\text{aux}}$}{ad(tupla(enConjunto: conj(paquete), porID: diccAVL(ID{,}
tupla(iPaquete: itConj(paquete){,}codOrigen: nat{,} codDestino: nat{,} porPrioridad:heap(tupla(prioridad{,}
itConjunto(paquete)))))))/a, ad(tupla(enConjunto: conj(paquete), porID: diccAVL(ID{,} tupla(iPaquete:
itConj(paquete){,}codOrigen: nat{,} codDestino: nat{,} porPrioridad: heap(tupla(prioridad{,}
itConjunto(paquete)))))))/b, nat}{ad(tupla(enConjunto: conj(paquete), porID: diccAVL(ID{,}
tupla(iPaquete: itConj(paquete){,}codOrigen: nat{,} codDestino: nat{,} porPrioridad:
heap(tupla(prioridad{,} itConjunto(paquete)))))))}{tam(a)>1 $\land$ tam(b)>0}
\end{verbatim}
...
\tadAxioma{finAd$_{\text{aux}}$($a$, $b$, $n$)}{\IF ($n$=0) THEN $b$[0] $\leftarrow$ $a$[1] ELSE finAd$_{\text{aux}}$($a$, $b$[n]$\leftarrow$ $a$[$n$+1], $n$ -1) FI}
 ...
 % aca estoy poniendo los axiomas de las funciones que use en el rep
  \tadOperacion{colaPriorAConj}{colaPrior(tupla<prioridad{,} ItConj(paquete)>)}{conj(tupla<prioridad{,} ItConj(paquete)>)}{}
  \tadAxioma{colaPriorAConj(c)}{\IF vacia?(c) THEN $\emptyset$ ELSE ag(proximo(c), colaPriorAConj(desencolar(c))) FI}
...
\begin{Algoritmos}
 ...
 \datosAlgoritmo{} % Descripción
  ...
  \begin{algoritmo}{iCaminoRecorrido}{\In{d}{DCNet}, \In{p}{paquete}}{lista(compu)}
    ...
    \While(\com*[f]{$\Theta(n \times log(k))$}){!(Definido?(($d$.paquetesEnEspera[$o$]).porID), $p$.ID)}{
      AgregarAtras($res$, siguiente($d$.IPsCompusPorID[0]))\com*{$\Theta(I)$ lo tomamos como $\Theta(1)$}
 ...
 \datosAlgoritmo{} % Descripción
  ...
  \begin{algoritmo}{iLaQueM\'{a}sEnvio}{\In{d}{DCNet}}{compu}
    $res \gets$ siguiente($d$.laQueM\'{a}sEnvio) \com*{$\Theta(1)$}
  \end{algoritmo}
  \datosAlgoritmo{} % Descripción
  {} % Pre
  {} % Post
  {$\Theta(1)$} % Complejidad
  {Lo tomamos como $\Theta(1)$, aunque copiar una computadora o devolver el siguiente de un iterador a computadora es $\Theta(I)$} % Justificacíón
