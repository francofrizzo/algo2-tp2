...
\tadOperacion{caminoDelPaquete}{ad(ad(nat)), ad(ItRed), ad(tupla(enConjunto: conj(paquete), porID: diccLog(ID{,} tupla(iPaquete: itConj(paquete){,}codOrigen: nat{,} codDestino: nat{,} porPrioridad: colaPrior(tupla(prioridad{,} itConjunto(paquete)))))), paquete, ad(tupla(enConjunto: conj(paquete), porID: diccLog(ID{,} tupla(iPaquete: itConj(paquete){,}codOrigen: nat{,} codDestino: nat{,} porPrioridad: colaPrior(tupla(prioridad{,} itConjunto(paquete))))))}{secu(compu)}{} %FALTA AGREGAR RESTRICCION y alinear bien los parametros - Manu 
...
\tadOperacion{caminoDelPaquete$_{\text{aux}}$}{ad(ad(nat)), ad(ItRed), ad(tupla(enConjunto: conj(paquete){,} porID: diccLog, tupla(iPaquete: itConj(paquete){,}codOrigen: nat{,} codDestino: nat{,} porPrioridad: colaPrior(tupla(prioridad{,} itConjunto(paquete)))))), paquete, ad(tupla(enConjunto: conj(paquete), porID: diccLog(ID{,} tupla(iPaquete: itConj(paquete){,}codOrigen: nat{,} codDestino: nat{,} porPrioridad: colaPrior(tupla(prioridad{,} itConjunto(paquete)))))), nat, nat}{secu(compu)}{} %AGREGAR RESTRICCION  

\small\begin{verbatim}
\tadOperacion{caminoDelPaquete$_{\text{aux}}$}{ad(ad(nat)), ad(ItRed), ad(tupla(enConjunto:
conj(paquete){,} porID: diccLog, tupla(iPaquete: itConj(paquete){,}codOrigen: nat{,}
codDestino: nat{,} porPrioridad: colaPrior(tupla(prioridad{,} itConjunto(paquete)))))),
paquete, ad(tupla(enConjunto: conj(paquete), porID: diccLog(ID{,} tupla(iPaquete:
itConj(paquete){,}codOrigen: nat{,} codDestino: nat{,} porPrioridad: colaPrior(tupla(prioridad{,}
...
\tadOperacion{finAd}{ad(tupla(enConjunto: conj(paquete), porID: diccLog(ID{,} tupla(iPaquete: itConj(paquete){,}codOrigen: nat{,} codDestino: nat{,} porPrioridad: colaPrior(tupla(prioridad{,} itConjunto(paquete)))))))}{ad(tupla(enConjunto: conj(paquete), porID: diccLog(ID{,} tupla(iPaquete: itConj(paquete){,}codOrigen: nat{,} codDestino: nat{,} porPrioridad: colaPrior(tupla(prioridad{,} itConjunto(paquete)))))))}{}
\small\begin{verbatim}
\tadOperacion{finAd}{ad(tupla(enConjunto: conj(paquete), porID: diccLog(ID{,} tupla(iPaquete:
itConj(paquete){,}codOrigen: nat{,} codDestino: nat{,} porPrioridad: colaPrior(tupla(prioridad{,}
itConjunto(paquete)))))))}{ad(tupla(enConjunto: conj(paquete), porID: diccLog(ID{,} tupla(iPaquete:
itConj(paquete){,}codOrigen: nat{,} codDestino: nat{,} porPrioridad: colaPrior(tupla(prioridad{,}
itConjunto(paquete)))))))}{}
\end{verbatim}
...
\tadOperacion{finAd$_{\text{aux}}$}{ad(tupla(enConjunto: conj(paquete), porID: diccLog(ID{,} tupla(iPaquete: itConj(paquete){,}codOrigen: nat{,} codDestino: nat{,} porPrioridad: colaPrior(tupla(prioridad{,} itConjunto(paquete)))))))/a, ad(tupla(enConjunto: conj(paquete), porID: diccLog(ID{,} tupla(iPaquete: itConj(paquete){,}codOrigen: nat{,} codDestino: nat{,} porPrioridad: colaPrior(tupla(prioridad{,} itConjunto(paquete)))))))/b, nat}{ad(tupla(enConjunto: conj(paquete), porID: diccLog(ID{,} tupla(iPaquete: itConj(paquete){,}codOrigen: nat{,} codDestino: nat{,} porPrioridad: colaPrior(tupla(prioridad{,} itConjunto(paquete)))))))}{tam(a)>1 $\land$ tam(b)>0}

\small\begin{verbatim}
\tadOperacion{finAd$_{\text{aux}}$}{ad(tupla(enConjunto: conj(paquete), porID: diccLog(ID{,}
tupla(iPaquete: itConj(paquete){,}codOrigen: nat{,} codDestino: nat{,} porPrioridad:colaPrior(tupla(prioridad{,}
itConjunto(paquete)))))))/a, ad(tupla(enConjunto: conj(paquete), porID: diccLog(ID{,} tupla(iPaquete:
itConj(paquete){,}codOrigen: nat{,} codDestino: nat{,} porPrioridad: colaPrior(tupla(prioridad{,}
itConjunto(paquete)))))))/b, nat}{ad(tupla(enConjunto: conj(paquete), porID: diccLog(ID{,}
tupla(iPaquete: itConj(paquete){,}codOrigen: nat{,} codDestino: nat{,} porPrioridad:
colaPrior(tupla(prioridad{,} itConjunto(paquete)))))))}{tam(a)>1 $\land$ tam(b)>0}
\end{verbatim}
...
\begin{Algoritmos}
  ...
  \begin{algoritmo}{iIniciarDCNet}{\In{r}{Red}}{DCNet}
    $res$.red $\gets$ \copiar{$r$}\com*{$\Theta(n \times I)$}   
    ...
    \While(\com*[f]{$\Theta(n)$}){$j$ < \card{\compus{$res$.red}}}{
