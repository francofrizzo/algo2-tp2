...
\begin{Interfaz}
  ...
  [$\Theta(n³ \times I² \times L + camMin)$]%complejidad
...
\begin{Algoritmos}
 ...
 \datosAlgoritmo{} % Descripción
  {} % Pre
  {} % Post
  {$\Theta(n \times I + 4 n + n \times (n + I² + L) + n \times (n \times (n + I + camMin)))$ = $\Theta(n \times I + n + n²+ n \times I² + n \times L + n³ + n² \times I + camMin)$ que esta incluido en $\Theta(n³ \times I² \times L + camMin)$} % Complejidad
  {} % Justificacíón
