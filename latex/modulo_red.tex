...
\begin{Interfaz}
  ...
  \textbf{g\'{e}neros:} \TipoVariable{red, itRed}
  ...
  [Genera una nueva Red sin ninguna computadora. "vac\'{i}a" ]%descripcion
  []%aliasing
  ...
  \InterfazFuncion{conectar}{\Inout{$R$}{Red}, \In{$c_{0}$}{compu}, \In{$i_{0}$}{interfaz}, \In{$c_{1}$}{compu}, \In{$i_{1}$}{interfaz}}{Red}%
  ...
  [$\Theta(1234)$]%complejidad
  [Conecta la pc $c_{0}$ con la pc $c_{1}$ a travez de las intergaces $i_{0}$ y $i_{1}$ respectivamente. ]%descripcion
  []%aliasing
  ...
  [$\Theta(1234)$]%complejidad
  [Devuelve todos los caminos minimos posibles entre $c_{0}$ y $c_{1}$, de no haber ninguno devuelve $\emptyset$. ]%descripcion
  []%aliasing
  ...
  [$\Theta(1234)$]%complejidad
  [Devuelve ture si y solo si hay algun camino posible entre $c_{0}$ y $c_{1}$. ]%descripcion
  []%aliasing
...
\begin{Algoritmos}
  ...
  \begin{algoritmo}{iCrearConjuntoDeInterfaces}{\In{l}{lista(tupla$\langle$interfaz, itLista(estrCompu)$\rangle$)}}{conj(estrInterfaz)}}{}
    \tipo{nat} $n \gets$ 0\;
    $res \gets$ vacio()\;
   \While{n < longitud(l)}{
  ...
  \begin{algoritmo}{iCaminos}{\In{$r$}{estrRed}, \In{$c_{0}$}{estrCompu}, \In{$c_{1}$}{estrCompu}}{conj(lista(estrCompu))}{}
