...
\begin{Interfaz}
  ...
  \Titlo{Operaciones b\'{a}sicas de red}
  ...
  \Titlo{Operaciones b\'{a}sicas del iterdor de red}
...
\begin{Representacion}
  ...
  \tadAxioma{armarCompus($e$)}{$\lange e$.IP, dame$\Pi_{1}$($e$.conecciones)$\rangle$}

  ~

  \tadOperacion{dame$\Pi_{1}$}{secu(tupla$\lange inter$: interfaz, $itCompu$: itLista(estrCompu)$\rangle$)/l}{conj(interfaz)}{}
