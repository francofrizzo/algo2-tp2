...
\newenvironment{algoritmo}[2]{
  \NoCaptionOfAlgo\SetAlgoLongEnd\LinesNumbered\SetAlgoLined\RestyleAlgo{ruled}\IncMargin{1em}\DontPrintSemicolon\SetArgSty{}\SetCommentSty{textsf}\SetFuncSty{textsf}\begin{algorithm}[H]
